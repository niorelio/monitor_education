...
class ShopController:
    ...
    def run(self):
        while True:
            ...
            print(f'[DEBUG] Выбран пункт меню: {choice}')  # Отладочный вывод
            ...
            if choice == 1:
                ...
                print(f'[DEBUG] Добавляем товар: name={name}, price={price}, quantity={quantity}')  # Отладочный вывод
                self.model.add_product(name, price, quantity)
                self.model.debug_print_products()  # Выводим текущие товары после добавления
